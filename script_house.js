    ...
    methods: {
       ...
       fetch("https://api.propublica.org/congress/v1/113/house/members.json", {
        ...
        handleChange(members){
            var selectedParty = document.querySelectorAll(".party:checked");//return number when checkbox checked as nodelist
            ...
            var myParty = Array.from(selectedParty);//convert nodelist to array
